...
describe Honeybadger::Api::Notice do
  ...
  describe 'a notice' do
    ...
    it 'is does not care if deeply nested keys are strings or symbols' do
      @notice1 = Honeybadger::Api::Notice.new(foo: { bar: 'baz' })
      @notice2 = Honeybadger::Api::Notice.new('foo' => { 'bar' => 'baz' })
